...
// Copyright (c) 2015-2018 The ZCore developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWELLPathCustom = GetArg("-zzcrbackuppath", "");
    ...
    if(!strzWELLPathCustom.empty()) {
        ui->wallet_customzzcrbackuppath->setText(QString::fromStdString(strzWELLPathCustom));
        ui->wallet_customzzcrbackuppath_label->setVisible(true);
        ui->wallet_customzzcrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWELLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ZCore RPC console.") + "<br>" +
