...
#ifndef ZCore_ZWELLWALLET_H
#define ZCore_ZWELLWALLET_H
...
public:
    CzWELLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZWELL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZWELL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ZCore_ZWELLWALLET_H
